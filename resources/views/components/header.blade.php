<header class="sticky top-0 bg-gradient-to-r from-violet-300 via-pink-400 to-red-400">
    <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        ...
        <nav  :class="{'flex': open, 'hidden': !open}" class="flex-col hidden pb-4 grow md:pb-0 md:flex md:justify-end md:flex-row md:gap-x-6 gap-y-4 md:gap-y-0">
                            {{--            @if ( request()->is('posts.*') )--}}
                            {{--                <a--}}
    ...
    {{--            </a>--}}
            ...
            <a
                ...
                <p class="font-extrabold text-black md:hidden">TDW</p>
